 ...
 */
export default async function resolveBusiness(session, metaRow, state) {
    ...
    if (igId) {
        ...
        return {
            complete: false,
            question: `I see the connected Instagram account for ${brandName}. Should I use it for this post?`
        };
    }
