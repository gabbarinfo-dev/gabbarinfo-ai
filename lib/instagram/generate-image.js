...
export async function generateImage(state, visualMood, taglineOverride) {
    ...
    console.log(`🎨 [DALL-E 3 HD] Generating bespoke ad poster for "${service}" (${businessName})...`);
    ...
    try {
        ...
        console.log(`✅ [DALL-E 3 HD] Creative generated & stored: ${publicUrl}`);
        ...
        console.error("========== OPENAI DALL-E 3 IMAGE ERROR ==========");
        console.error(e);
        throw e;
    }
}
