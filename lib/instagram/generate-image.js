...
if (method === "website") {
    contactFooter = state.assets.websiteUrl
        ? state.assets.websiteUrl
        : "Visit our website";
} 
else if (method === "phone" || method === "whatsapp") {
    contactFooter = state.assets.phone
        ? state.assets.phone
        : "Contact us directly";
}
    ...
    const prompt = `
        ...
        - C- Contact Info: ${contactFooter ? `Include "${contactFooter}" as a clean footer text.` : "No footer text needed."}
