...
[VISUAL STYLE]
- STYLE: Professional architectural or lifestyle photography.
- LIGHTING: Dynamic and atmospheric (matches the Mood).
- AESTHETIC: High-end, premium brand marketing visual. No cliches.
- COLOR PALETTE: Natural colors consistent with "${service}" and "${effectiveMood}".

[IMAGE CONTENT]
- A realistic, high-end visual representing "${service}" in a professional setting. 
- Avoid repeating the same composition or "golden" glow every time. Use varied perspectives.
    `;
