...

{
  ...
  "visual_mood": "A creative visual style (e.g. '3D isometric digital office', 'Flat-lay overhead creative desk', 'Vibrant neon 3D elements', 'High-contrast sharp studio product', 'Bold minimalist vector art')"
}
        `;
        ...
        return {
            ...
            visualMood: data.visual_mood || ["3D Isometric view", "Overhead flat-lay", "Sharp studio lighting", "High-contrast digital art"][Math.floor(Math.random() * 4)]
        };
