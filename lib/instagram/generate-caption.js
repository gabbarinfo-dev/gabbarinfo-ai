...

{
  ...
  "visual_mood": "A 3-5 word artistic mood description (e.g. 'Moody cinematic shadows', 'Vibrant neon pulse', 'Earthy natural sunlight', 'Golden hour warmth')"
}
        `;
        ...
        return {
            ...
            visualMood: data.visual_mood || ["Cinematic lighting", "Natural soft light", "Clean minimalist", "High-contrast photography"][Math.floor(Math.random() * 4)]
        };
