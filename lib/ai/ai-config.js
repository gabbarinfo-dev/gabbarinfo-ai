...
export const AI_MODELS = {
  ...
  // Approved OpenAI Image Model Hierarchy (Strictly gpt-image models, NO DALL-E)
  IMAGE_MODELS: [
    "gpt-image-2",
  ...
  // Graceful fallback image models if primary is temporarily unavailable
  IMAGE_FALLBACK_1: "gpt-image-2-2026-04-21",
  IMAGE_FALLBACK_2: "gpt-image-1.5",
  IMAGE_FALLBACK: "gpt-image-2-2026-04-21",
