...
export function buildVideoTimeline({ script, voiceover, scenes, backgroundBeat = "upbeat_lofi" }) {
  ...
  // Background beat royalty-free tracks (Served locally from /audio with zero hotlink blocking)
  const beats = {
    upbeat_lofi: "/audio/upbeat_lofi.mp3",
    commercial_energetic: "/audio/commercial_energetic.mp3",
    chill_acoustic: "/audio/chill_acoustic.mp3",
  };
