 ...
 */
export async function generateReelScript({ topic, niche = "general", style = "motion_broll", language = "en_us" }) {
  let langInstruction = "Language: American English (US). Dynamic, punchy American social media tone.";
  if (language === "hindi") {
    langInstruction = "Language: Hindi (हिंदी). Write the spoken voiceover ('fullScript' and scene 'text') in natural, energetic, conversational Hindi that engages viewers immediately. Keep 'searchQuery' in English for accurate stock video retrieval.";
  } else if (language === "en_uk") {
    langInstruction = "Language: British English (UK). Use authentic British English spelling, vocabulary, and articulate tone.";
  }
  ...
  "scenes": [
    {
      ...
      "cameraAngle": "Dynamic medium close-up, dramatic cinematic lighting",
      "searchQuery": "2-3 precise english keywords for vertical stock footage search",
      "visualPrompt": "Detailed cinematic prompt for AI character/video generation, 9:16 vertical orientation, actor naturally delivering hook with expressive eyes",
      "duration": 4
    },
    {
      "id": 2,
      ...
      "cameraAngle": "Over-the-shoulder close-up angle",
      "searchQuery": "keywords for scene 2",
      "visualPrompt": "cinematic prompt for scene 2, fluid motion, atmospheric lighting",
      "duration": 4
    },
    {
      "id": 3,
      ...
      "cameraAngle": "Low angle reaction close-up",
      "searchQuery": "keywords for scene 3",
      "visualPrompt": "cinematic prompt for scene 3, dramatic focus shift",
      "duration": 4
    },
    {
      "id": 4,
      ...
      "cameraAngle": "Direct to camera eye-level framing",
      "searchQuery": "keywords for scene 4",
      "visualPrompt": "cinematic prompt for scene 4, impactful finish",
      "duration": 4
    }
  ]
}

Respond ONLY with raw valid JSON, no markdown codeblocks.`;

  // 1. Try Gemini (Gemini 1.5 Pro or Flash)
